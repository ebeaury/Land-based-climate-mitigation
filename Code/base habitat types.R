...
#### INPUTS NEEDED:
# Described in detail in Table S1, supporting methods
...
# lvl1_frac_1km_ver004.zip

## Peatland supporting data:
...
## Inputs: IUCN habitat types & peatland supporting data
...
#### Set directory to input dataset folder ####
path = ""
setwd(path)
